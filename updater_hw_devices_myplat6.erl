...
-export([get_slot_id_myplat6_lc4/0]).
-export([get_slot_id_myplat6_sc2000/0]).
-export([get_slot_id_myplat6_lc5/0]).

-export([power_cycle_myplat6_mngt/0]).
-export([power_cycle_myplat6_lc4/0]).
-export([power_cycle_myplat6_sc2000/0]).
-export([power_cycle_myplat6_lc5/0]).

-export([get_version_myplat6_mngt_fpga/0]).
-export([get_version_myplat6_fan_lpc55/0]).
-export([get_version_myplat6_fan_cpld/0]).
-export([get_version_myplat6_lc4_lpc55/0]).
-export([get_version_myplat6_lc4_fpga/0]).
-export([get_version_myplat6_lc4_cpld/0]).
-export([get_version_myplat6_sc2000_lpc55/0]).
-export([get_version_myplat6_sc2000_cpld/0]).
-export([get_version_myplat6_lc5_lpc55/0]).
-export([get_version_myplat6_lc5_fpga/0]).
-export([get_version_myplat6_lc5_cpld/0]).
-export([get_version_myplat6_lc5_pm6010/0]).

-export([update_myplat6_fan_lpc55/0]).
-export([update_myplat6_fan_cpld/0]).
...
get_version_myplat6_mngt_fpga() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_fan_lpc55() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_fan_cpld() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc4_lpc55() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc4_fpga() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc4_cpld() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_sc2000_lpc55() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_sc2000_cpld() ->
    {error, ?NOT_IMPLEMENTED}.
...
get_version_myplat6_lc5_lpc55() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc5_fpga() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc5_cpld() ->
    {error, ?NOT_IMPLEMENTED}.


get_version_myplat6_lc5_pm6010() ->
    {error, ?NOT_IMPLEMENTED}.
